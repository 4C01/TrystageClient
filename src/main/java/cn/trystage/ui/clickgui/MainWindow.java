...
public class MainWindow extends GuiScreen {
    ...
    public static Category currentCategory = Category.MOVEMENT;
...
//        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawGradientRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), mainColor.getRGB(), new Color(0, 0, 0, 30).getRGB());
        ...
        //Background
        RenderUtil.drawRoundedRect(x, y, x + width, y + height, 2, new Color(0, 0, 0));
        RenderUtil.drawRoundedRect(x, y, x + width, y + 35, 2, new Color(0, 0, 0));
...
//                rollX2 = 0;
        ...
        for (ModuleWindow mw : mods) {
            if (mw.mod.category == currentCategory) {
...
//                    modsY += mw.height2 + (mw.mod.value.size() == 0 ? 25 : 20) + 10;
//                }
            }
        }
