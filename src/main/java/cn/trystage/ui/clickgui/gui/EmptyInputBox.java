    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                Minecraft.getMinecraft().fontRendererObj.drawString(s1, (int) l, (int) i1, i);
                j1 = Minecraft.getMinecraft().fontRendererObj.getStringWidth(s1) + l;
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = Minecraft.getMinecraft().fontRendererObj.drawString(s.substring(j), (int) j1, (int) i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1 + l, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                } else {
                    Minecraft.getMinecraft().fontRendererObj.drawString("_", (int) k1, (int) i1, i);
                }
            }
