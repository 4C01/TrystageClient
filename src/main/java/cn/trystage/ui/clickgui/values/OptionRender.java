...
public class OptionRender extends ValueRender {
    ...
    public OptionRender(AbstractValue v, float x, float y) {
        super(v, x, y);
    }
    ...
    public void onRender(float valueX, float valueY) {
        ...
        if (((Boolean) value.getValue())) {
            ...
            Minecraft.getMinecraft().fontRendererObj.drawString(value.getName(), (int) (valueX + 16), (int) (valueY + 1), new Color(115,115,115).getRGB());
        } else {
            RenderUtil.drawRect(valueX + 5, valueY, valueX + 12, valueY + 7, mainColor);
