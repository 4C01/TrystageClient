package cn.trystage.command;

import java.util.HashMap;
import java.util.Map;

import cn.trystage.Client;
import cn.trystage.command.commands.BindCommand;
import cn.trystage.command.commands.HelpCommand;
import cn.trystage.command.commands.ToggleCommand;
    ...
    public boolean processCommand(String rawMessage) {
        ...
        if (safe) {
            ...
            /** If no command was found it tell the user to do the help command. **/
                ...
                PlayerUtils.tellPlayer("No Command named that, Try -help ");
            }
        }
        /**
