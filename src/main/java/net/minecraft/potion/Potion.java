...
public class Potion
{
    ...
    private static final  Map<Potion, ResourceLocation> POTION_RESOURCE_LOCATION_MAP = Maps.<Potion, ResourceLocation>newHashMap();
    ...
    protected Potion(int potionID, ResourceLocation location, boolean badEffect, int potionColor)
    {
        ...
        POTION_RESOURCE_LOCATION_MAP.put(this,location);
        if (badEffect)
        {
    ...
    public ResourceLocation getResourceLocationFromPotion()
    {
        return (ResourceLocation)POTION_RESOURCE_LOCATION_MAP.get(this);
    }
