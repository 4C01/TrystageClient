...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        Client.INSTANCE.getDiscordInstance().update("Idle","Main Menu");
    }
...
//        自定义背景
        mc.getTextureManager().bindTexture(new ResourceLocation("Trystage/images/bg.png"));
        int h = (int) (this.width * 0.684);
        int w = (int) (this.height * 1.462);
        if(this.height > this.width){
            this.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height,w, this.height);
        } else{
            this.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height,this.width, h);
        }
        FontManager.font42.drawCenteredString(Client.INSTANCE.name, this.width / 2, this.height / 4, -1);
//        FontManager.font42.drawCenteredString(Client.INSTANCE.name, this.width / 2, 70.0F, -1);
