...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        SplashProgress.setPrgress(1,"Minecraft - Initialize Render");
        ...
        SplashProgress.setPrgress(1,"Minecraft - Initialize GUI");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("IntelliJ IDEA Ultimate Edition 2023.3.4");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.getClass().getResourceAsStream("/assets/minecraft/icon16x.png");
                inputstream1 = this.getClass().getResourceAsStream("/assets/minecraft/icon32x.png");
